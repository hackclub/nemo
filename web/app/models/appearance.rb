module Appearance
  ...
  THEMES = [
    ...
    Theme.new(key: "chalk", label: "Chalk", band: "light",
      swatch: ["oklch(95.1% 0.024 248)", "oklch(99.5% 0.0025 248)", "oklch(25.57% 0.03 252)"]),
    Theme.new(key: "sepia", label: "Sepia", band: "light",
